...
with gr.Blocks(css=css) as demo:
    ...
    with gr.Row():
        with gr.Column():
            ...
            extra_margin = gr.Slider(label="Extra Margin", minimum=0, maximum=40, value=5, step=1)
            parsing_mode = gr.Radio(label="Parsing Mode", choices=["jaw", "raw"], value="jaw")
            left_cheek_width = gr.Slider(label="Left Cheek Width", minimum=20, maximum=160, value=70, step=5)
            right_cheek_width = gr.Slider(label="Right Cheek Width", minimum=20, maximum=160, value=70, step=5)
